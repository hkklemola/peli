...
typedef enum EquipmentSlotType {
    ...
    EQUIP_SLOT_OFF_HAND,
    EQUIP_SLOT_ARMOUR_HEAD,
    EQUIP_SLOT_ARMOUR_EYES,
    EQUIP_SLOT_ARMOUR_FACE,
    EQUIP_SLOT_ARMOUR_NECK,
    EQUIP_SLOT_ARMOUR_SHOULDERS,
    EQUIP_SLOT_ARMOUR_CHEST,
    EQUIP_SLOT_ARMOUR_ARMS,
    EQUIP_SLOT_ARMOUR_HANDS,
    EQUIP_SLOT_ARMOUR_WAIST,
    EQUIP_SLOT_ARMOUR_LEGS,
    EQUIP_SLOT_ARMOUR_FEET,
    ...
    EQUIP_SLOT_CONTAINER_SCABBARD,
    EQUIP_SLOT_CONTAINER_SCABBARD_2,
    EQUIP_SLOT_CONTAINER_SCABBARD_3,
    EQUIP_SLOT_CONTAINER_SCABBARD_4,
    EQUIP_SLOT_CONTAINER_SCABBARD_5,
    EQUIP_SLOT_CONTAINER_SCABBARD_6,
    EQUIP_SLOT_COUNT
} EquipmentSlotType;
